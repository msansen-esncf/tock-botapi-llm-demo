...
public class ChatClient extends DifyClient {
     ...
     */
    public Response createChatMessage(Map<String, String> inputs, String query, String user, boolean stream, String conversation_id) throws DifyClientException {
        JSONObject json = new JSONObject();
        json.put("inputs", new JSONObject(inputs));
